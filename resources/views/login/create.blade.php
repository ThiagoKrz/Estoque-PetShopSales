...
<body>
  ...
  <main>
    <center>
      ...
      <h5 class="orange-text">Preencha os campos para criar sua conta</h5>
      <div class="section"></div>
        ...
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
            ...
            <div class='row'>
              <div class='input-field col s12'>
                ...
                <label for='email'>Seu sobrenome</label>
              </div>
            </div>
            <div class='row'>
              <div class='input-field col s12'>
            ...
            <center>
              <div class='row'>
                <button type='submit' name='btn_login' class='col s12 btn btn-large waves-effect orange'>Cadastrar</button>
              </div>
            </center>
          </form>
        </div>
